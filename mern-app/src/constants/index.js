export const surpriseMePrompts = [
  ...
  'bmw 6series from 80s in space and earth on the background',
  'toyota supra from 90s in space and earth on the background',
  'lamborghini diablo in space and earth on the background',
  'golf 1 gti from 80s in space and earth on the background',
  'bmw e46 m3 in space and earth on the background',
  'audi q8 in space and earth on the background',
];
